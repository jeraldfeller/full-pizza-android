...
*/
        ...
        '', $rrr_closetime_pre = '')
    {
        ...
        /*echo "<br><b>status----------------------=></b>".$openclosetype."<br>";*/
    ...
    function addressbooklist($cusid){
        ...
        if($cusid != ''){
            $sel_add = "SELECT ca.id, ca.customer_id, ca.customer_apartment_name, ca.customer_landmark, ca.customer_street, ca.customer_address_title, ca.customer_zip, ca.customer_landline, ca.customer_address_label, ca.status, ca.added_date, cty.cityname AS customer_city, st.statename AS customer_state
                            FROM 
