...
Instalación de Php
Proceder a instalar Php la versión mínima 5.6.

Instalación de MySql. 
Realizar la instalación de MySQL así como phpMyAdmin(el manejador de la base de datos).
```
...
Luego de aplicar las configuraciones previas se puede correr la aplicación con la url asignada desde el servidor.
