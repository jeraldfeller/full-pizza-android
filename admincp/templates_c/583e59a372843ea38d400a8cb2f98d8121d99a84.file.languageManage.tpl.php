<?php /* Smarty version Smarty-3.1.21-dev, created on 2016-09-09 03:02:58
         compiled from "/var/sentora/hostdata/admin/public_html/fullpizzadev_mobilemediacms_com/admincp/templates/languageManage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:53167008657d1d90a8bf368-15280210%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '583e59a372843ea38d400a8cb2f98d8121d99a84' => 
    array (
      0 => '/var/sentora/hostdata/admin/public_html/fullpizzadev_mobilemediacms_com/admincp/templates/languageManage.tpl',
      1 => 1466424149,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '53167008657d1d90a8bf368-15280210',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57d1d90af20687_70523738',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57d1d90af20687_70523738')) {function content_57d1d90af20687_70523738($_smarty_tpl) {?><div class="page-header">
...
" class="textboxFilter" placeholder="Language Name/Code" />
...
','<?php echo $_REQUEST['keyword'];?>
');"<?php }?>>Language Name<?php if ($_REQUEST['sortby']=='lndesc') {?><img src="images/icon_arrow_down.png" alt="" title="Descending" /><?php } elseif ($_REQUEST['sortby']=='lnasc') {?><img src="images/icon_arrow_up.png" alt="" title="Ascending" /><?php } else { ?><img src="images/icon_arrow_up.png" alt="" title="Ascending" /><?php }?>
					</th>
					<th width="18%" >
						<a href="javascript:void(0);" <?php if ($_REQUEST['sortby']=='lcdesc') {?>onclick="sortByAscDesc('lcasc','<?php echo $_GET['limit'];?>
','<?php echo $_REQUEST['keyword'];?>
');"<?php } elseif ($_REQUEST['sortby']=='lcasc') {?>onclick="sortByAscDesc('lcdesc','<?php echo $_GET['limit'];?>
','<?php echo $_REQUEST['keyword'];?>
');"<?php } else { ?>onclick="sortByAscDesc('lcdesc','<?php echo $_GET['limit'];?>
','<?php echo $_REQUEST['keyword'];?>
');"<?php }?>>Language Code<?php if ($_REQUEST['sortby']=='lcdesc') {?><img src="images/icon_arrow_down.png" alt="" title="Descending" /><?php } elseif ($_REQUEST['sortby']=='lcasc') {?><img src="images/icon_arrow_up.png" alt="" title="Ascending" /><?php } else { ?><img src="images/icon_arrow_up.png" alt="" title="Ascending" /><?php }?>
						</a>
					</th>
                    <th width="5%">Id</th>
...
$_smarty_tpl->tpl_vars['smarty']->value['section']['lang']['loop'] = is_array($_loop=$_smarty_tpl->tpl_vars['languageName_list']->value) ? count($_loop) : max(0, (int) $_loop); unset($_loop);
...
?>
				<?php $_smarty_tpl->tpl_vars["trvar"] = new Smarty_variable($_smarty_tpl->getVariable('smarty')->value['section']['lang']['rownum'], null, 0);?>
				<tr  id="deletecate<?php echo $_smarty_tpl->tpl_vars['languageName_list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lang']['index']]['lang_id'];?>
">
					<td >
						<div class="checkbox checkbox-primary no-margin">
							<input type="checkbox" class="case" value="<?php echo $_smarty_tpl->tpl_vars['languageName_list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lang']['index']]['lang_id'];?>
" onclick="individualSelect();" id="tableselect_<?php echo $_smarty_tpl->getVariable('smarty')->value['section']['lang']['rownum'];?>
" />
							<label for="tableselect_<?php echo $_smarty_tpl->getVariable('smarty')->value['section']['lang']['rownum'];?>
"></label>
						</div>
					</td>
					<td><?php echo $_smarty_tpl->tpl_vars['languageName_list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lang']['index']]['sno'];?>
</td>
					<td ><?php echo $_smarty_tpl->tpl_vars['languageName_list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lang']['index']]['lang_name'];?>
</td>
					<td ><?php echo $_smarty_tpl->tpl_vars['languageName_list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lang']['index']]['lang_code'];?>
</td>
                    <td ><?php echo $_smarty_tpl->tpl_vars['languageName_list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lang']['index']]['lang_id'];?>
</td>
					<td ><?php echo $_smarty_tpl->tpl_vars['languageName_list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lang']['index']]['addeddate'];?>
</td>
					<td>
						<?php if ($_smarty_tpl->tpl_vars['languageName_list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lang']['index']]['lang_site']=='Yes') {?>
						<img src="images/star_yellow.png" alt="" title="Site Language" onclick="return changeStatus('No','lang_site','<?php echo $_smarty_tpl->tpl_vars['whereField']->value;?>
','<?php echo $_smarty_tpl->tpl_vars['tablename']->value;?>
','<?php echo $_smarty_tpl->tpl_vars['word']->value;?>
','<?php echo $_smarty_tpl->tpl_vars['languageName_list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lang']['index']]['lang_id'];?>
');" style="cursor:pointer;" />
						<?php } else { ?>
						<img src="images/star_grey.png" alt="Normal" title="Normal" onclick="return changeStatus('Yes','lang_site','<?php echo $_smarty_tpl->tpl_vars['whereField']->value;?>
','<?php echo $_smarty_tpl->tpl_vars['tablename']->value;?>
','<?php echo $_smarty_tpl->tpl_vars['word']->value;?>
','<?php echo $_smarty_tpl->tpl_vars['languageName_list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lang']['index']]['lang_id'];?>
');" style="cursor:pointer;" />
					...
					<td id="chgstatus<?php echo $_smarty_tpl->tpl_vars['languageName_list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lang']['index']]['lang_id'];?>
">
						<?php if ($_smarty_tpl->tpl_vars['languageName_list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lang']['index']]['lang_status']=='1') {?>
...
');" style="cursor:pointer;" />
					...
					<td >
						<a href="languageAddEdit.php?langid=<?php echo $_smarty_tpl->tpl_vars['languageName_list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lang']['index']]['lang_id'];?>
&langcode=<?php echo $_smarty_tpl->tpl_vars['languageName_list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lang']['index']]['lang_code'];?>
&lfile=header.php">Edit <?php echo $_smarty_tpl->tpl_vars['languageName_list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['lang']['index']]['lang_code'];?>
 Files</a>
					</td>
                    <?php if ($_smarty_tpl->tpl_vars['VIEWABLE']->value=='Yes') {?>
					<td>
