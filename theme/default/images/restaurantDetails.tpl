...
<div class="container">
	<div class="row">
		...
		<div class="col-md-8 bordeContenedores text-center" style="padding-left: 0; padding-right: 0">
			<img style="width: 20%;" class="" src="theme/default/images/MenuTitle.png">
							...
							{if $categoryList[catdet].cat_name neq ''}
								...
								{if $categoryList[catdet].cat_name eq 'Items Populares'}
									  ...
									  {elseif $categoryList[catdet].cat_name eq 'Pizzas'}
									    ...
									    <table class="categoryMenuTables">
											<tr>
												<td class="PizzaListIcon" width="20%"><img style="width: 40%;" class="" src="theme/default/images/PizzaIcon.png"></td>
												<td class="PizzaListText" width="80%"><a class="menus_detailsLink" id='cat_name{"/[^a-zA-Z0-9]/"|preg_replace:"":$categoryList[catdet].cat_name}' name='cat_name{"/[^a-zA-Z0-9]/"|preg_replace:"":$categoryList[catdet].cat_name}'> {$categoryList[catdet].cat_name}</a></td>
											</tr>	
										</table>
										</h3>
									  <div>
										...
										{section name=menu loop=$categoryMenuList}
											...
											<div id="orderPizzaContainer" class="hide">
													    ...
													    <div class="modal-dialog modal-dialog-centered">
													      <div class="modal-content">
													        ...
													        <div class="modal-body">
													         Desea algún Extra?        
													         <a class="btn btn-default" href="https://www.google.com" role="button">SI</a>
													        </div>
												...
												<p style="font-size: x-large !important;" class="AgentOrange">Desea agregar extras?</p>
												<button class="goToCheckout" onclick="checkoutArrayPizza()" data-target="#myModal"></button>
									...
									{elseif $categoryList[catdet].cat_name eq 'Bebidas'}
									    ...
									    <table class="categoryMenuTables">
											<tr>
												<td class="PizzaListIcon" width="20%"><img style="width: 40%;" class="" src="theme/default/images/Drinks.png"></td>
												<td class="PizzaListText" width="80%"><a class="menus_detailsLink" id='cat_name{"/[^a-zA-Z0-9]/"|preg_replace:"":$categoryList[catdet].cat_name}' name='cat_name{"/[^a-zA-Z0-9]/"|preg_replace:"":$categoryList[catdet].cat_name}'> {$categoryList[catdet].cat_name}</a></td>
											</tr>	
										</table>
										</h3>
																...
																<li>
																	...
																	<form id='myform' method='POST' action='#'>
																	    <input type='button' class='qtyminusDrinks' field='quantityDrinks{$smarty.section.size.index}' />
                                                                                                                                            <input type='text' class="AgentOrange qtyIndicator" name='quantityDrinks{$smarty.section.size.index}' value='0' class='qty' width=10% />
									  ...
									  {elseif $categoryList[catdet].cat_name eq 'Postres'}
									    ...
									    <table class="categoryMenuTables">
											<tr>
												<td class="PizzaListIcon" width="20%"><img style="width: 40%;" class="" src="theme/default/images/Desserts.png"></td>
												<td class="PizzaListText" width="80%"><a class="menus_detailsLink" id='cat_name{"/[^a-zA-Z0-9]/"|preg_replace:"":$categoryList[catdet].cat_name}' name='cat_name{"/[^a-zA-Z0-9]/"|preg_replace:"":$categoryList[catdet].cat_name}'> {$categoryList[catdet].cat_name}</a></td>
											</tr>	
										</table>
										</h3>
