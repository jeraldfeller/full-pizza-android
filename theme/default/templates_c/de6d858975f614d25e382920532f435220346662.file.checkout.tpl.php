<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-07-24 21:40:11
         compiled from "C:\wamp\www\theme\default\templates\checkout.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10800591a7be21fae07-80996607%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'de6d858975f614d25e382920532f435220346662' => 
    array (
      0 => 'C:\\wamp\\www\\theme\\default\\templates\\checkout.tpl',
      1 => 1500950408,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '10800591a7be21fae07-80996607',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_591a7be30cc2b8_17014721',
  'variables' => 
  array (
    'subtotal' => 0,
    'offervalue' => 0,
...
<?php if ($_valid && !is_callable('content_591a7be30cc2b8_17014721')) {function content_591a7be30cc2b8_17014721($_smarty_tpl) {?><div class="container">
			...
			<div class="customerLeftBox clearfix">
				<div class="checkBg no_margin">
						...
						<!-- <?php if ($_REQUEST['deliverypickup']=='pickup') {?>
							<?php echo $_smarty_tpl->tpl_vars['LANG']->value['checkout_pickup'];?>

						<?php } else { ?>
							<?php echo $_smarty_tpl->tpl_vars['LANG']->value['checkout_delivery'];?>

						<?php }?> -->
						<?php if ($_SESSION['delivery_pickup']=='pickup') {?>
							<h1 class="customSignupHead">
								Recoger en: <br>
								<p style="font: 14px source_sans_proregular;"><?php echo $_SESSION['addressPickup'];?>
 </p>
							</h1>
						<?php } else { ?>
...
">
							...
							<div>
								<div class="form-group">
									<label for="apartmentaddress" id="apartmentaddresslabel" class="col-sm-4 control-label font-normal"><span class="redStar"><?php echo utf8_encode($_smarty_tpl->tpl_vars['LANG']->value['checkout_mandatory_symbol']);?>
</span>Apartamento Numero/ Apartment Number</label>
									<div class="col-sm-5">
										<input class="form-control" type="text" name="apartmentaddress" id="apartmentaddress" value="<?php echo $_SESSION['apartment'];?>
" />
										<span id="deliveryaddresserrormsg"></span>
									</div>
								</div>
								<div class="form-group">
									<label for="companyaddress" id="companyaddresslabel" class="col-sm-4 control-label font-normal"><span class="redStar"><?php echo utf8_encode($_smarty_tpl->tpl_vars['LANG']->value['checkout_mandatory_symbol']);?>
</span>Compañia / Company</label>
									<div class="col-sm-5">
										<input class="form-control" type="text" name="companyaddress" id="companyaddress" value="<?php echo $_SESSION['company'];?>
" />
										<span id="deliveryaddresserrormsg"></span>
									</div>
								</div>
								<div class="form-group">
									<label for="universityaddress" id="universityaddresslabel" class="col-sm-4 control-label font-normal"><span class="redStar"><?php echo utf8_encode($_smarty_tpl->tpl_vars['LANG']->value['checkout_mandatory_symbol']);?>
</span>Universidad / University</label>
									<div class="col-sm-5">
										<input class="form-control" type="text" name="universityaddress" id="universityaddress" value="<?php echo $_SESSION['university'];?>
" />
										<span id="deliveryaddresserrormsg"></span>
									</div>
								</div>
								<div class="form-group">
									<label for="facultyaddress" id="facultyaddresslabel" class="col-sm-4 control-label font-normal"><span class="redStar"><?php echo utf8_encode($_smarty_tpl->tpl_vars['LANG']->value['checkout_mandatory_symbol']);?>
</span>Facultad / Faculty</label>
									<div class="col-sm-5">
										<input class="form-control" type="text" name="facultyaddress" id="facultyaddress" value="<?php echo $_SESSION['faculty'];?>
" />
										<span id="deliveryaddresserrormsg"></span>
									</div>
								</div>
								<div class="form-group">
									<label for="flooraddress" id="flooraddresslabel" class="col-sm-4 control-label font-normal"><span class="redStar"><?php echo utf8_encode($_smarty_tpl->tpl_vars['LANG']->value['checkout_mandatory_symbol']);?>
</span>Piso / Floor</label>
									<div class="col-sm-5">
										<input class="form-control" type="text" name="flooraddress" id="flooraddress" value="<?php echo $_SESSION['floor'];?>
" />
										<span id="deliveryaddresserrormsg"></span>
									</div>
								</div>
