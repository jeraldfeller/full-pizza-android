<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-07-20 14:54:28
         compiled from "C:\wamp\www\theme\default\templates\customerMyaccount.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1470257df5ff2490c25-88601593%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8c8ffc5ff35bf6208a17b297ab6c42bd7491338f' => 
    array (
      0 => 'C:\\wamp\\www\\theme\\default\\templates\\customerMyaccount.tpl',
      1 => 1500567529,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1470257df5ff2490c25-88601593',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_57df5ff2948675_60799979',
  'variables' => 
  array (
    'LANG' => 0,
    'objCustomer' => 0,
...
<?php if ($_valid && !is_callable('content_57df5ff2948675_60799979')) {function content_57df5ff2948675_60799979($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'C:\\wamp\\www\\includes\\smarty\\plugins\\modifier.date_format.php';
...
<nav class="navbar navbar-default" role="navigation">
  ...
  <div class="collapse navbar-collapse navbar-ex1-collapse">
    <ul class="myaccInnerNewMenuUlNew nav navbar-nav">
      <li class="active" id="customer_myorder"><a href="#"><?php echo $_smarty_tpl->tpl_vars['LANG']->value['customer_myacc_my_order_history'];?>
</a></li>
      <li id="customer_profile"><a href="#"><?php echo $_smarty_tpl->tpl_vars['LANG']->value['customer_myacc_profile'];?>
</a></li>
      <li id="customer_addressbook"><a href="#"><?php echo $_smarty_tpl->tpl_vars['LANG']->value['customer_myacc_address_book'];?>
</a></li>
      <li id="customer_changepassword"><a href="#"><?php echo $_smarty_tpl->tpl_vars['LANG']->value['customer_myacc_change_password'];?>
</a></li>
      <li id="customer_favorties"><a href="#"><?php echo $_smarty_tpl->tpl_vars['LANG']->value['cus_myacc_favorites'];?>
</a></li>     
    </ul>
  </div>
</nav>
...
" />
							...
							<div class="form-group">
								<div class="col-sm-4 col-sm-offset-4">
									<input class="submit-bg-new" type="button" onclick="return customerUpdateProfile();" value="<?php echo $_smarty_tpl->tpl_vars['LANG']->value['cus_myacc_update'];?>
" />
								</div>
							</div>
						</div>
				...
				<div style="padding: 0;" class="MyAccountBg clearfix">
					...
					<div style="padding: 15px">
						...
						<div class="myAccInnerBg clearfix form-horizontal">
							...
							<div class="form-group">
								<div class="col-sm-4 col-sm-offset-4">
									<input class="submit-bg-new" type="button" onclick="return customerChangePassword();" value="<?php echo $_smarty_tpl->tpl_vars['LANG']->value['customer_myacc_change_password'];?>
" />
								</div>
							</div>
						</div>
					...
					<form name="customer_review" class="form-horizontal" method="post" onsubmit="return customerReviewsSubmit();" action="">
						...
						<div class="form-group">
							<div class="col-sm-5 col-sm-offset-4">
								<input class="submit-bg-new" id="review" type="submit" value="<?php echo $_smarty_tpl->tpl_vars['LANG']->value['cus_myacc_submit'];?>
" />
							</div>
						</div>
					</form>
