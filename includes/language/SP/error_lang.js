function error_language(){
    ...
    errLangArr['enter_your_reset_password']         = "Please enter your password";
    errLangArr['enter_your_retype_password']        = "Please enter your retype password";
    errLangArr['enter_your_wrong_password']         = "New password and confirm password should be same!";
    
    
	
	//Customer Register 
	errLangArr['cus_reg_empty_name'] 				= "Completa tu nombre";
	errLangArr['cus_reg_correct_name']				= "Please enter valid name";
	errLangArr['cus_reg_empty_lastname'] 			= "Completa tu apellido";
	...
	errLangArr['cus_reg_empty_zip'] 				= "Please enter zip code";
	errLangArr['cus_reg_empty_city'] 				= "Please select city";
	errLangArr['cus_reg_empty_state'] 				= "Please select state";
	...
	errLangArr['cus_reg_empty_phone'] 				= "Completa tu número de teléfono";
	errLangArr['cus_reg_correct_phone']				= "Please enter valid phone";
	errLangArr['cus_reg_empty_email'] 				= "Introduce un correo";
	errLangArr['cus_reg_confirm_email'] 			= "El correo y la confirmación no coinciden";
	errLangArr['cus_reg_confirm_email_empty'] 		= "Debes confirmar tu correo";
	errLangArr['cus_reg_invalid_email'] 			= "Formato de correo invalido";
	errLangArr['cus_reg_empty_password'] 			= "Introduce una contraseña";
	errLangArr['cus_reg_empty_conpassword'] 		= "Debes confirmar tu contraseña";
	errLangArr['cus_reg_invalid_password'] 		    = "La contraseña y su confirmación no coinciden";
	...
	//Customer Login 
	errLangArr['cus_login_email_empty'] 			= "Please enter e-mail address";
	errLangArr['cus_login_email_valid'] 			= "Invalid e-mail address";
	...
	errLangArr['cus_login_forgetemail_empty'] 		= "Please enter e-mail address";
	errLangArr['cus_login_forgetemail_valid'] 		= "Invalid e-mail address";
	...
	errLangArr['cus_profile_update_street'] 		= "Please enter street address";
	errLangArr['cus_profile_update_email'] 			= "Please enter e-mail";
    errLangArr['cus_profile_update_emailvalid'] 	= "Please enter valid e-mail";
	errLangArr['cus_profile_update_phone'] 			= "Please enter phone number";
	errLangArr['cus_profile_update_phonenocheck']	= "Please enter valid phone number";
	errLangArr['cus_profile_update_phonenoless'] 	= "Please enter valid phone number";
	...
	errLangArr['cus_addressbook_update_street'] 	= "Please enter street address";
	errLangArr['cus_addressbook_update_area'] 		= "Please enter area";
	errLangArr['cus_addressbook_update_city'] 		= "Please select city";
	errLangArr['cus_addressbook_update_state'] 		= "Please select state";
	errLangArr['cus_addressbook_update_landline'] 	= "Please enter valid landline number";
	errLangArr['cus_addressbook_update_zip'] 	    = "Please enter zip code";
	errLangArr['cus_addressbook_update_validzip'] 	= "Please enter valid zip code";
	...
	errLangArr['cus_changepass_check_retypepass'] 	= "Please enter confirm password";
	...
	errLangArr['res_owner_res_correctname']			= "Please enter valid restaurant name";
    ...
    errLangArr['res_owner_res_validname']			= "Please enter valid contact name";
	...
	errLangArr['res_owner_res_contactemail']		= "Please enter restaurant contact e-mail";
	errLangArr['res_owner_res_invalidemail']		= "Invalid e-mail address";
	...
	errLangArr['res_owner_res_streetaddr']			= "Please enter restaurant street address";
	errLangArr['res_owner_res_city']				= "Please select restaurant city";
	errLangArr['res_owner_res_state']				= "Please select restaurant state";
	errLangArr['res_owner_res_zip']					= "Please enter restaurant zip code";
	errLangArr['res_owner_res_correctzip']			= "Please enter restaurant valid zip code";
	...
	errLangArr['res_owner_login_email']				= "Please enter e-mail address";
	errLangArr['res_owner_login_invalidemail']		= "Invalid e-mail address";
	...
	errLangArr['res_owner_forgetpass_email']		= "Please enter e-mail address";
	errLangArr['res_owner_forgetpass_invalidemail']	= "Invalid e-mail address";
	errLangArr['res_owner_forgetpass_sendemail']	= "Password has been sent to your e-mail address";
	errLangArr['res_owner_forgetpass_notregemail']	= "This e-mail address not registered";
	...
	errLangArr['res_owner_offer_from']				= "Please enter offer from date";
	errLangArr['res_owner_offer_to']				= "Please enter offer to date";
	errLangArr['res_owner_offer_validto']			= "Please enter valid offer to date";
	...
	errLangArr['res_owner_account_resstate']		= "Please select restaurant state";
	errLangArr['res_owner_account_rescity']			= "Please select restaurant city";
	errLangArr['res_owner_account_reszip']			= "Please enter restaurant zip code";
	...
	errLangArr['res_owner_account_email']			= "Please enter e-mail";
	errLangArr['res_owner_account_validemail']		= "Please enter valid e-mail";
	...
	errLangArr['res_owner_setting_contactemail']  	= "Please enter e-mail";
	errLangArr['res_owner_setting_validemail']  	= "Please enter valid e-mail";
	...
	errLangArr['payment_paypal_email']				= "Please enter contact e-mail";
	errLangArr['payment_paypal_invalidemail']		= "Invalid e-mail address";
	...
	errLangArr['payment_paypal_mailexist']			= "This e-mail id is already exist";
	errLangArr['payment_paypal_timesess']			= "Please enter time";
	errLangArr['payment_paypal_timesess']			= "Please enter time";
	errLangArr['payment_paypal_timesess']			= "Please enter time";
	errLangArr['payment_paypal_timesess']			= "Please enter time";
	...
	//Alert Messages
    errLangArr['alert_message_to_search']           = "Please enter cityname to search";
    errLangArr['alert_message_to_zipsearch']        = "Please enter zipcode to search";
    errLangArr['alert_message_to_valid']            = "Please enter Valid value in Text box";
	errLangArr['alert_message_indexarea']			= "Please enter search area or city or zipcode";
	...
	//submitOrder
	errLangArr['submit_order_contactname']			= "Please enter first name";
	...
	errLangArr['submit_order_city']					= "Please select delivery city";
	errLangArr['submit_order_zip']					= "Please enter delivery zip";
	errLangArr['submit_order_state']				= "Please select delivery state";
	...
	errLangArr['submit_order_email']				= "Please enter contact e-mail";
	errLangArr['submit_order_invalidemail']			= "Invalid e-mail address";
	...
	errLangArr['submit_order_mailexist']			= "This e-mail id is already exist";
    errLangArr['submit_order_addexist']			    = "This Address title is already exist";
	...
	errLangArr['contact_email']					= 'Please enter contact e-mail address';
	errLangArr['conatct_valid_contactmail']		= 'Please enter valid e-mail address';
	...
	errLangArr['booking_email']					= 'Please enter e-mail';
	errLangArr['booking_invalidemail']			= 'Invalid e-mail';
	...
	errLangArr['common_plese_enter_youremail']	= "Please enter your e-mail";	
	errLangArr['common_plese_enter_validmail']	= "Please enter valid e-mail";
	errLangArr['common_plese_enter_yourcountry']= "Please enter your country";
	errLangArr['common_plz_enter_valideaddress']= "Please enter valid e-mail address";
	errLangArr['common_error_occured']			= "Error Occured";
	errLangArr['common_invalid_email_id']		= "Invalid e-mail id";	
	errLangArr['common_fbinvalid_email_id']		= "Invalid e-mail id";
	errLangArr['common_please_enter_name']		= "Please enter name";
	errLangArr['common_please_enter_validname']	= "Please enter valid name";
	errLangArr['common_please_enter_email']		= "Please enter e-mail id";
	errLangArr['common_please_enter_validemail']= "Please enter valid e-mail id";
	...
	errLangArr['common_please_enter_name']		= "Please enter name";
	errLangArr['common_please_enter_validname']	= "Please enter valid name";	
	errLangArr['common_please_enter_emailid']	= "Please enter e-mail id";
	errLangArr['common_please_enter_validid']	= "Please enter valid e-mail id";
	errLangArr['common_please_enter_country']	= "Please enter country";
	errLangArr['common_please_enter_message']	= "Please enter message";
	...
	errLangArr['customer_email_already_exists']	= "This e-mail id already exist";	
	errLangArr['customer_pwd_has_been_sent']	= "Password has been sent to your e-mail address";
	errLangArr['customer_email_address_not_reg']= "This e-mail address not registered";
    ...
    errLangArr['Please_enter_the_reason']       = "Please enter the reason for disclaim order";

    //Commission
    errLangArr['res_owner_setting_commission']     	= "Please enter commission";
    errLangArr['res_owner_setting_comis_valchar']   = "Please enter valid Commission";
