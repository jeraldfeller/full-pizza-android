...
#print_r($_SESSION['restaurantownerid']);
...
$objRestaurant->getShowCategoryList($_SESSION['restaurantownerid']);
...
$main_content = $objSmarty->fetch('restaurantOwnerMyaccount_menu.tpl');
